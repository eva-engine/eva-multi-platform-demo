...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _localStorage2 = __webpack_require__(23);

	var _localStorage3 = _interopRequireDefault(_localStorage2);

	var _location2 = __webpack_require__(24);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HTMLCanvasElement = exports.HTMLCanvasElement = function (_HTMLElement) {
...
/***/ (function(module, exports) {
	...
	function _triggerEvent(type) {
	  ...
	  if (this.evts[type]) {
	    this.evts[type].forEach(function (evt) {
	      evt.apply(_this, args);
	    });
	  }
	}
	...
	var XMLHttpRequest = function () {
	  ...
	  _createClass(XMLHttpRequest, [{
	        ...
	        if (url.indexOf('http:') === 0 || url.indexOf('https:') === 0 || url.indexOf('//') === 0) {
	          wx.request({
	            ...
	            fail: function fail(arg) {
	              return _this2.fail(arg);
	            },
	            success: function success(arg) {
	              return _this2.success(arg);
	            }
	          });
	        } else {
	          fs.readFile({
	    ...
	    key: 'addEventListener',
	    value: function addEventListener(name, evt) {
	      this.evts[name] = this.evts[name] || [];
	      this.evts[name].push(evt);
	    }
	  }, {
	    key: 'removeEventListener',
	    value: function removeEventListener(name, evt) {
	      if (!this.evts[name]) {
	        return;
	      }
	      var index = this.evts[name].indexOf(evt);
	      if (index) {
